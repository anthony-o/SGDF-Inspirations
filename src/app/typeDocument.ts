...
export var TYPES_DOCUMENTS_BY_FOLDER_NAME: Map<string, TypeDocument> = new Map<string, TypeDocument>(Object.entries({  // Object => Map grâce à https://stackoverflow.com/a/36644558/535203
